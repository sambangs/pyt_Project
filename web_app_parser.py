...
parser = argparse.ArgumentParser(description="run the web app for CRUD operations on scrapped data")

parser.add_argument('--op', type=str, default='run',
                       help='What operation (RUN,run)')
